...
class ServiceDetailsSalon extends StatefulWidget {
  @override
  _ServiceDetailsSalonState createState() => _ServiceDetailsSalonState();
}

class _ServiceDetailsSalonState extends State<ServiceDetailsSalon> {
  bool isLoading = true;
  Location location;
  Details details;
  List<EmployeeDetailList> employeeDetailList;
  List<ParlourServiceDetails> salonServiceDetails;
  ...
  Future _loadDatafromFirestore(String uid) async {
    try {
      ...
      setState(() {
        ...
        salonServiceDetails = List.from(data
            .data()['servicesList']
                    ...
                    actions: [
                      Padding(
                          ...
                          child: Container(
                              ...
                              child: Image.asset('assets/salon.png')))
                    ],
                  )),
